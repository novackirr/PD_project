...
urlpatterns = [
    ...
    path('student_decision/', StudenTestDecision.as_view()),

    path('user_list_without_option/', StudentsListHaveNoOption.as_view()),
    path('user_list_with_option/', StudentsListHaveOption.as_view()), 
